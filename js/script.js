...
ScrollReveal().reveal('.footer-contact', {delay:"100",duration:"1000",origin:"right",easing:"ease" });
ScrollReveal().reveal('.footer-control', {delay:"1200",duration:"1300",origin:"left",easing:"ease"});
...
// ScrollReveal().reveal('.profile-info-left', {delay:"700",duration:"1000",origin:"left",interval:500,easing:"ease"});
// ScrollReveal().reveal('.profile-info-right', {delay:"700",duration:"1000",origin:"right",interval:500,easing:"ease" });

// ScrollReveal().reveal('.info-section-left', {delay:"700",duration:"1000",origin:"left",easing:"ease"});
// ScrollReveal().reveal('.info-section-right', {delay:"700",duration:"1000",origin:"right",easing:"ease" });

// ScrollReveal().reveal('.skill-section', {delay:"700",duration:"1000",origin:"left",easing:"ease",scale:1.1 });

// // ScrollReveal().reveal('.project-section', {delay:"800",duration:"1000",easing:"ease" });
// ScrollReveal().reveal('.chillflix', {delay:"800",duration:"1500",origin:"left",easing:"ease" });
// ScrollReveal().reveal('.bank', {delay:"1000",duration:"1800",origin:"right",easing:"ease" });
// ScrollReveal().reveal('.shortern', {delay:"1200",duration:"2100",origin:"left",easing:"ease" });
// ScrollReveal().reveal('.modern', {delay:"1400",duration:"2400",origin:"right",easing:"ease" });

// // ScrollReveal().reveal('.services-section', {delay:"1200",duration:"1000",origin:"left",easing:"ease" });
// ScrollReveal().reveal('.service-1', {delay:"1000",duration:"1200",origin:"left",easing:"ease",scale:1.05 });
// ScrollReveal().reveal('.service-2', {delay:"1300",duration:"1800",origin:"left",easing:"ease",scale:1.1 });
// ScrollReveal().reveal('.service-3', {delay:"1500",duration:"2500",origin:"left",easing:"ease",scale:1.3 });


// ScrollReveal().reveal('.footer-contact', {delay:"1300",duration:"1800",origin:"right",easing:"ease" });
// ScrollReveal().reveal('.footer-control', {delay:"1500",duration:"2000",origin:"left",easing:"ease"});